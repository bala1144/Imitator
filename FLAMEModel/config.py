...
parser = argparse.ArgumentParser(description = 'FLAMEModel model')
...
parser.add_argument(
    ...
    help = 'Static landmark embeddings path for FLAMEModel'
)
...
parser.add_argument(
    ...
    help = 'Dynamic contour embedding path for FLAMEModel'
)

# FLAMEModel hyper-parameters
